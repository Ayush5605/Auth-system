...
const Login=()=> {
    ...
    return ( 
        ...
        px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
            <img src={assets.logo} alt="" className='absolute left-5
            ...
            text-indigo-300 text-sm'>
                ...
                <h2 className='text-3xl font-semibold text-white text-center mb-3'>{state==='Sign Up'?'Create account' :
                'Login '}</h2>
                ...
                <form>
                    ...
                    {state==='Sign Up' && (
                        ...
                        <input  className='bh-transparent outline-none'type="text" 
                    ...
                    rounded-full bg-[#333A5C]'>
                        ...
                        <input  className='bh-transparent outline-none'type="email" 
                    ...
                    rounded-full bg-[#333A5C]'>
                        ...
                        <input  className='bh-transparent outline-none'type="password" 
