            ...
            text-indigo-300 text-sm'>
                ...
                <form onSubmit={onSubmitHandler}>
                    ...
                    {state==='Sign Up' && (
                        ...
                        value={name}
                        className='bh-transparent outline-none'type="text" 
                    ...
                    rounded-full bg-[#333A5C]'>
                        ...
                        value={email} className='bh-transparent outline-none'type="email" 
                    ...
                    rounded-full bg-[#333A5C]'>
                        ...
                        value={password}className='bh-transparent outline-none'type="password" 
